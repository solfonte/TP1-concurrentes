...
mod test_container_recharger_controller {
    ...
    use crate::coffee_maker_components::{
        container::Container, provider_container::ProviderContainer,
    };
    use std::sync::Arc;
    ...
    fn test01_when_needing_to_recharge_three_units_that_are_available_the_extraction_result_is_three(
        ...
        let controller = ContainerRechargerController::new(Arc::new(ProviderContainer::new(
            10,
            0.2,
    ...
    fn test02_when_needing_to_recharge_three_units_and_two_are_available_the_extraction_result_is_two(
        ...
        let container = ProviderContainer::new(10, 0.2, String::from("Provider"));
